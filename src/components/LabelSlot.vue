    ...
    methods: {
        ...
        onKeyDown(event: KeyboardEvent){
            ...
            if(this.labelSlotsIndex === 0 && this.slotId.indexOf(",") == -1 && !hasTextSelection  &&
                (event.key === "=" || event.key === " ") && !event.ctrlKey && (this.frameType === AllFrameTypesIdentifier.varassign || this.frameType === AllFrameTypesIdentifier.list || this.frameType === AllFrameTypesIdentifier.set)){
